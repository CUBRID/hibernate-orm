...
//		functionFactory.concat_pipeOperator();
	...
	public int getInExpressionCountLimit() {
		//CUBRID rejects an expression nested beyond 400 levels; before 11.0 a multi-key batch
		//is emulated as one 'or' per key tuple, so bound the batch at limit/key columns
		return 500;
	}
