...
public class NativeQueryResultTypeAutoDiscoveryTest {
	...
	@SkipForDialect(dialectClass = CUBRIDDialect.class, reason = "CUBRID caps numeric precision at 38 and this mapping declares 50, so the table is never created")
	...
	@SkipForDialect(dialectClass = InformixDialect.class, reason = "The scale exceeds the maximum precision specified")
	@SkipForDialect(dialectClass = SpannerDialect.class, reason = "The value too big for standard Spanner Numeric precision limits (38.9)")
	@SkipForDialect(dialectClass = CUBRIDDialect.class, reason = "CUBRID caps decimal precision at 38 and this mapping declares 50, so the table is never created")
