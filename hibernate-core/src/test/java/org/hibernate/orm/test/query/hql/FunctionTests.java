...
//							is("hellohellohello") );
	...
	@SkipForDialect(dialectClass = CUBRIDDialect.class, reason = "CUBRID cannot cast character varying to bit varying, and the cast is only rejected once a row is present")
